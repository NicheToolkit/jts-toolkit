...
public class SimpleShapeWriter extends ShapeWriter<SimpleShapefile> {
    ...
    protected LinkedHashMap<String, Class> attributeClassMap;
    ...
    @Override
    public SimpleFeatureTypeBuilder typeBuilder(File shapefile, LinkedHashMap<String, Class> attributeClassMap) throws RestException {
        return typeBuilder(shapefile, null, attributeClassMap);
    }

    @Override
    public SimpleFeatureTypeBuilder typeBuilder(String filename, LinkedHashMap<String, Class> attributeClassMap) throws RestException {
        return typeBuilder(filename, null, attributeClassMap);
    }

    @Override
    public SimpleFeatureTypeBuilder typeBuilder(File shapefile, Geometries geometries, LinkedHashMap<String, Class> attributeClassMap) throws RestException {
    ...
    @Override
    public SimpleFeatureTypeBuilder typeBuilder(String filename, Geometries geometries, LinkedHashMap<String, Class> attributeClassMap) throws RestException {
    ...
    @Override
    public ShapefileDataStore dataStore(File shapefile, LinkedHashMap<String, Class> attributeClassMap) throws RestException {
        SimpleFeatureTypeBuilder typeBuilder = typeBuilder(shapefile, attributeClassMap);
        return dataStore(shapefile, typeBuilder);
    }

    @Override
    public ShapefileDataStore dataStore(File shapefile, String filename, LinkedHashMap<String, Class> attributeClassMap) throws RestException {
        SimpleFeatureTypeBuilder typeBuilder = typeBuilder(filename, attributeClassMap);
        return dataStore(shapefile, typeBuilder);
    }

    @Override
    public ShapefileDataStore dataStore(File shapefile, Geometries geometries, LinkedHashMap<String, Class> attributeClassMap) throws RestException {
        SimpleFeatureTypeBuilder typeBuilder = typeBuilder(shapefile, geometries, attributeClassMap);
        return dataStore(shapefile, typeBuilder);
    }

    @Override
    public ShapefileDataStore dataStore(File shapefile, String filename, Geometries geometries, LinkedHashMap<String, Class> attributeClassMap) throws RestException {
    ...
    @Override
    public File write(File shapeFile, LinkedHashMap<String, Class> attributeClassMap, Collection<SimpleShapefile> shapefiles) throws RestException {
    ...
    @Override
    public File write(File shapeFile, Geometries geometries, LinkedHashMap<String, Class> attributeClassMap, Collection<SimpleShapefile> shapefiles) throws RestException {
    ...
    public LinkedHashMap<String, Class> getAttributeClassMap() {
        return attributeClassMap;
    }

    public void setAttributeClassMap(LinkedHashMap<String, Class> attributeClassMap) {
