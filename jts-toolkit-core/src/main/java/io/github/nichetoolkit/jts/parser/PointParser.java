...
public class PointParser extends JtsParser<Point> {
     ...
     * @param array {@link tools.jackson.databind.JsonNode} <p>The array parameter is <code>JsonNode</code> type.</p>
     ...
     * @param node {@link tools.jackson.databind.JsonNode} <p>The node parameter is <code>JsonNode</code> type.</p>
